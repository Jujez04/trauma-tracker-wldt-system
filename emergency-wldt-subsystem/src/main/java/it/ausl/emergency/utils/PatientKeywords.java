...
/**
 * Chiavi utilizzate per descrivere il Physical Asset del Paziente (proprietà ed eventi) e per
 * mappare in modo coerente i campi di {@link it.ausl.emergency.model.payload.PatientTelemetryPayload}
 * sulle proprietà del Digital Twin State.
 *
 * Gli eventi ricalcano i Domain Events individuati nell'analisi DDD della tesi (cap. 3.2.4):
 * Riscontro Clinico Eseguito, Deterioramento Clinico Rilevato, Handover Completato.
 */
